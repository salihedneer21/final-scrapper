              ...
              <div className="mt-3">
                <div className="bg-emerald-50 border border-emerald-100 rounded-lg p-5">
                  ...
                  <div className="text-gray-600 text-sm">
                    For personalized estimate, Please verify insurance when you book a session.
                  </div>
                </div>
              </div>
            )}
...
Have you been to therapy before?
      ...
      case 'reason':
        ...
        case 'insuranceNote':
          return (
            <div className="mb-4 py-3 px-4 bg-blue-50 rounded-md border border-blue-100">
              <div className="flex items-center">
                <div className="mr-3 flex-shrink-0">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" style={{ color: primaryColor }} viewBox="0 0 20 20" fill="currentColor">
                    <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clipRule="evenodd" />
                  </svg>
                </div>
                <div>
                  <h4 className="text-sm font-medium" style={{ color: primaryColor }}>Insurance Information</h4>
                  <p className="text-sm text-gray-600 mt-0.5">
                    You can add insurance details later, but they'll be required before your appointment is confirmed.
                  </p>
                </div>
              </div>
            </div>
